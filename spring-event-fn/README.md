...
This sample project contains a single function based on Spring Cloud Function: `spring-event-fn.echo.java.main.src.EchoFunction`, which returns an echo of the data passed via CloudEvents.
